    ...
    <nav class="sidebar close">
        <header>
            <div class="image-text">
                <span class="image">
                    <a href="../professor/dash-professor" title="Dash">
                        <img src="../assets/img/logoProVest.png" alt="">
                    </a>
                </span>

                <div class="text logo-text">
                    <span class="name">ProVest - Professor</span>
                    <span class="profession"><?= substr($dados['nome_professor'], 0, 8); ?></span>
                </div>
            </div>
        ...
        <div class="menu-bar">
            <div class="menu">
                ...
                <ul class="menu-links">
                    <li class="nav-link">
                        <a href="../professor/perfil-professor" title="Perfil">
